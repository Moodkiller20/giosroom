"""
Django settings for giosroom project.
...
SECRET_KEY = 'django-insecure-@woo0!3)ryipq3qgq!=5p^y*o&*r5ovdma4*l%i5p5fhinhl$s'
...
WSGI_APPLICATION = 'giosroom.wsgi.application'
